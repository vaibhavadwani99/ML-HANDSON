...
class Test_Train(unittest.TestCase):
    def test_parse_args(self):
        self.assertEqual(train.args.dataset,"/mnt/d/mle-training/data/processed/train.csv")
        self.assertEqual(train.args.output_model_path,"/mnt/d/mle-training/artifacts/models/")
